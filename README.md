...
*CONTEXTO E OBJETIVO(S)*: Criar um espaço de conhecimento, com fontes confiáveis, sobre a história de vida e carreira de Taylor Swift, como forma de acesso interativo aos interessados pelo conteúdo. A curadoria da bibliografia (visto que o limite era de 50 fontes) foi baseada principalmente no impacto da cantora como compositora e artista na indústria musical, além de sua influência na cultura pop mundial até os dias atuais. 
